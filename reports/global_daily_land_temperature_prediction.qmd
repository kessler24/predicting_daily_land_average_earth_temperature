...
read_csv('../data/global_temp_anomaly_cleaned_train.csv')
```
...
![Visualize why Day of Year and Month are correlated and why it is not anomalous.](../images/month_vs_day_of_year_correlation.png){#fig-cor-line width=50%}
...
read_csv('../images/train_df_eda_table_1.csv')
```
...
read_csv('../images/train_df_eda_table_2.csv')
```
...
read_csv('../results/model_results.csv')
```

...
plot Show plot via image link and size control for report
```

![Target Distribution Visualization (training data). Right-skewness is expected due to increasing anomalies in recent years.](../images/eda_plot_1.png){#fig-hist width=60%}
